...
1. Copy the link from glitch.io where the combined script is currently served: https://glitch.com/edit/#!/bubbly-abrupt-pin?path=hover-shape-combined.js%3A73%3A2
